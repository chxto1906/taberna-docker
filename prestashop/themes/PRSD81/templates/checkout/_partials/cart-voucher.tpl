            ...
            <ul class="promo-name card-block">
              {foreach from=$cart.vouchers.added item=voucher}
                <li class="cart-summary-line">
                  ...
                  <a href="{$voucher.delete_url}" data-link-action="remove-voucher"><i class="fa fa-trash-o"></i></a>
        ...
        <div class="promo-code collapse{if $cart.discounts|count > 0} in{/if}" id="promo-code">
          ...
          {block name='cart_voucher_notifications'}
            <div class="alert alert-danger js-error" role="alert">
              <i class="fa fa-exclamation-circle" aria-hidden="true"></i><span class="m-l-1 js-error-text"></span>
            </div>
          {/block}
        </div>
