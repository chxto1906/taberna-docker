...
<section id="main" itemscope itemtype="https://schema.org/Product">
  ...
  <div class="row">
    ...
    <div class="col-md-7">
      ...
      <h1 class="product_title h1" itemprop="name">{block name='page_title'}{$product.name}{/block}</h1>
      {/block}
      {/block}
      ...
      {block name='product_comment'}
          {capture name='displayProductExtra'}{hook h='displayProductExtra'}{/capture}
          {if $smarty.capture.displayProductExtra}
            {$smarty.capture.displayProductExtra nofilter}
          {/if}
        {/block}
        ...
        <div class="tabs">
          <ul class="nav nav-tabs" role="tablist">
            ...
            {block name='product_comment_tab'}
              {capture name='displayProductTab'}{hook h='displayProductTab'}{/capture}
              {if $smarty.capture.displayProductTab}
                {$smarty.capture.displayProductTab nofilter}
              {/if}
            {/block}
          </ul>
          ...
          <div class="tab-content" id="tab-content">
           ...
           {block name='product_comment_tab_content'}
                  {capture name='displayProductTabContent'}{hook h='displayProductTabContent'}{/capture}
                  {if $smarty.capture.displayProductTabContent}
                    {$smarty.capture.displayProductTabContent nofilter}
                  {/if}
                {/block}
        ...
        {block name='product_accessories'}
          ...
          <section class="product-accessories products_block clearfix">
            ...
            <div class="rv-titletab">
              <h2 class="tab_title">{l s='You might also like' d='Shop.Theme.Catalog'}</h2>
              </div>
              <div class="block_content">
                <div id="accessories-carousel" class="owl-carousel products">
                  {foreach from=$accessories item=product_accessory name=accessoriesProducts}
