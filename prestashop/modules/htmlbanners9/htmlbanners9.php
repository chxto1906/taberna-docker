...
class HtmlBanners9 extends Module implements WidgetInterface
{
    ...
    protected function installSamples()
    {
        ...
        foreach ($languages as $language) {
            $slide->title[$language['id_lang']] = 'Spring 2018';
            $slide->description[$language['id_lang']] = '<h2>Spring 2018</h2>
            <h3>New collection</h3>
            <p><button class="btn btn-default btn_skine-two" type="button">Learn more</button></p>';
            $slide->legend[$language['id_lang']] = 'Spring 2018';
    ...
    public function getWidgetVariables($hookName = null, array $configuration = array())
    {
        ...
        return array(
            'htmlbanners9' => array(
                ...
                'pause' => $config['HTMLBANNERS9_PAUSE_ON_HOVER'] ? 'hover' : '',
