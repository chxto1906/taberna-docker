    ...
    public function SampleDataInstall()  {
        ...
        for ($i = 1; $i <= 6; $i++) {
            ...
            elseif ($i==2):
                ...
                $des='Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries.';
            elseif ($i==3):
            ...
            elseif ($i==6):
                $title='Nostro expetenda volupta';
                $slug='nostro-expetenda-voluptatum-sit-ex';
                $des='Doctus omittam intellegam duo in. Ius ne sint dicit accusamus, cu pri solum decore corpora. Mei melius audire ex. Nostrum ocurreret cum at. Ut apeirian invenire eleifend eos, mei velit vituperata at.';
            endif;
            foreach ($languages as $language) {
