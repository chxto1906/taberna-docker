        ...
        <article class=" single_blog_post cat_post p_bottom_20 m_bottom_30 clearfix col-sm-{$per_column}" id="smartblogpost-{$post.id_post}">
            ...
            <figure class="post_thumbnail m_bottom_20">
                <a itemprop="url" title="{$post.meta_title}" href="{smartblog::GetSmartBlogLink('smartblog_post',$options)}" class="imageFeaturedLink">
                    <img itemprop="image" alt="{$post.meta_title}" src="{$link->getMediaLink($smart_module_dir)}/smartblog/images/{$post.post_img}-{$image_type}.jpg" class="img-responsive">
                </a>
                <div class="blog_mask">
                    <div class="mask_content">
                        <a itemprop="url" title="{$post.meta_title}" href="{$link->getMediaLink($smart_module_dir)}/smartblog/images/{$post.post_img}.jpg" class="post_lightbox"><i class="icon-resize-full"></i></a>
