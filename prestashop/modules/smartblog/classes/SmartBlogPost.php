...
class SmartBlogPost extends ObjectModel
{
    ...
    public static function getPost($id_post, $id_lang = null)
    {
        ...
        $sql = 'SELECT * FROM '._DB_PREFIX_.'smart_blog_post p INNER JOIN '._DB_PREFIX_.'smart_blog_post_lang pl ON p.id_smart_blog_post=pl.id_smart_blog_post INNER JOIN '._DB_PREFIX_.'smart_blog_post_shop ps ON pl.id_smart_blog_post = ps.id_smart_blog_post WHERE pl.id_lang='.(int)($id_lang).' AND p.active= 1 AND p.id_smart_blog_post = '.(int)($id_post);
    ...
    public static function getAllPost($id_lang = null, $limit_start, $limit)
    {
        ...
        $sql = 'SELECT * FROM '._DB_PREFIX_.'smart_blog_post p INNER JOIN '._DB_PREFIX_.'smart_blog_post_lang pl ON p.id_smart_blog_post=pl.id_smart_blog_post INNER JOIN '._DB_PREFIX_.'smart_blog_post_shop ps ON pl.id_smart_blog_post = ps.id_smart_blog_post AND ps.id_shop = '.(int) Context::getContext()->shop->id.' WHERE pl.id_lang='.(int)($id_lang).' AND p.active= 1 ORDER BY p.id_smart_blog_post DESC LIMIT '.(int)$limit_start.','.(int)$limit;
    ...
    public static function getToltal($id_lang = null)
    {
        ...
        $sql = 'SELECT * FROM '._DB_PREFIX_.'smart_blog_post p INNER JOIN '._DB_PREFIX_.'smart_blog_post_lang pl ON p.id_smart_blog_post=pl.id_smart_blog_post INNER JOIN '._DB_PREFIX_.'smart_blog_post_shop ps ON pl.id_smart_blog_post = ps.id_smart_blog_post AND ps.id_shop = '.(int) Context::getContext()->shop->id.' WHERE pl.id_lang='.(int)($id_lang).' AND p.active= 1';
        if (!$posts = Db::getInstance()->executeS($sql)) {
            return false;
        }
        return count($posts);
    ...
    public static function getToltalByCategory($id_lang = null, $id_category = null)
    {
        ...
        $sql = 'SELECT * FROM '._DB_PREFIX_.'smart_blog_post p INNER JOIN '._DB_PREFIX_.'smart_blog_post_lang pl ON p.id_smart_blog_post=pl.id_smart_blog_post INNER JOIN '._DB_PREFIX_.'smart_blog_post_shop ps ON pl.id_smart_blog_post = ps.id_smart_blog_post AND ps.id_shop = '.(int) Context::getContext()->shop->id.' WHERE pl.id_lang='.(int)($id_lang).' AND p.active= 1 AND p.id_category = '.(int)($id_category);
        if (!$posts = Db::getInstance()->executeS($sql)) {
            return false;
        }
        return count($posts);
    ...
    public static function addTags($id_lang = null, $id_post, $tag_list, $separator = ',')
    {
        ...
        return Db::getInstance()->execute('INSERT INTO `'._DB_PREFIX_.'smart_blog_post_tag` (`id_tag`, `id_post`) VALUES '.$data);
    }
    ...
    {
        $id_lang = Context::getContext()->language->id;
        if (!$tmp = Db::getInstance(_PS_USE_SQL_SLAVE_)->executeS('SELECT  t.`name` FROM '._DB_PREFIX_.'smart_blog_tag t LEFT JOIN '._DB_PREFIX_.'smart_blog_post_tag pt ON (pt.id_tag = t.id_tag AND t.id_lang = '.(int)($id_lang).') WHERE pt.`id_post`='.(int)($id_post))) {
            return false;
        }
        return $tmp;
    }
    ...
    public static function getPopularPosts($id_lang = null)
    {
        ...
        $result = Db::getInstance(_PS_USE_SQL_SLAVE_)->executeS('SELECT p.id_author ,p.viewed ,p.created , p.id_smart_blog_post,pl.meta_title,pl.link_rewrite FROM '._DB_PREFIX_.'smart_blog_post p INNER JOIN '._DB_PREFIX_.'smart_blog_post_lang pl ON p.id_smart_blog_post=pl.id_smart_blog_post INNER JOIN '._DB_PREFIX_.'smart_blog_post_shop ps ON pl.id_smart_blog_post = ps.id_smart_blog_post AND ps.id_shop = '.(int) Context::getContext()->shop->id.' WHERE pl.id_lang='.(int)($id_lang).' AND p.active = 1 ORDER BY p.viewed DESC LIMIT 0,'.(int)$limit);
    ...
    public static function getRelatedPosts($id_lang = null, $id_cat = null, $id_post = null)
    {
        ...
        $sql = 'SELECT  p.id_smart_blog_post,p.created,pl.meta_title,pl.link_rewrite FROM '._DB_PREFIX_.'smart_blog_post p INNER JOIN '._DB_PREFIX_.'smart_blog_post_lang pl ON p.id_smart_blog_post=pl.id_smart_blog_post INNER JOIN '._DB_PREFIX_.'smart_blog_post_shop ps ON pl.id_smart_blog_post = ps.id_smart_blog_post AND ps.id_shop = '.(int) Context::getContext()->shop->id.' WHERE pl.id_lang='.(int)($id_lang).'  AND p.active = 1 AND p.id_category = '.(int)($id_cat).' AND p.id_smart_blog_post != '.(int)($id_post).' ORDER BY p.id_smart_blog_post DESC LIMIT 0,'.(int)$limit;
    ...
    public static function getRecentPosts($id_lang = null)
    {
        ...
        $result = Db::getInstance(_PS_USE_SQL_SLAVE_)->executeS('SELECT  p.id_author,p.id_smart_blog_post,p.created,pl.meta_title,pl.link_rewrite FROM '._DB_PREFIX_.'smart_blog_post p INNER JOIN '._DB_PREFIX_.'smart_blog_post_lang pl ON p.id_smart_blog_post=pl.id_smart_blog_post INNER JOIN '._DB_PREFIX_.'smart_blog_post_shop ps ON pl.id_smart_blog_post = ps.id_smart_blog_post AND ps.id_shop = '.(int) Context::getContext()->shop->id.' WHERE pl.id_lang='.(int)($id_lang).'  AND p.active = 1 ORDER BY p.id_smart_blog_post DESC LIMIT 0,'.(int)$limit);
    ...
    public static function tagsPost($tags, $id_lang = null)
    {
        ...
        $sql = 'SELECT * FROM '._DB_PREFIX_.'smart_blog_post p INNER JOIN '._DB_PREFIX_.'smart_blog_post_lang pl ON p.id_smart_blog_post=pl.id_smart_blog_post INNER JOIN '._DB_PREFIX_.'smart_blog_post_shop ps ON p.id_smart_blog_post=ps.id_smart_blog_post  AND  ps.id_shop = '.(int) Context::getContext()->shop->id.' INNER JOIN '._DB_PREFIX_.'smart_blog_post_tag pt ON pl.id_smart_blog_post = pt.id_post INNER JOIN '._DB_PREFIX_.'smart_blog_tag t ON pt.id_tag=t.id_tag WHERE pl.id_lang='.(int)($id_lang).'  AND p.active = 1 AND t.name="'.pSQL($tags).'"';
    ...
    public static function getArchiveResult($month = null, $year = null, $limit_start = 0, $limit = 5)
    {
        ...
        if ($month != '' and $month != null and $year != '' and $year != null) {
            $sql = 'SELECT * FROM '._DB_PREFIX_.'smart_blog_post s INNER JOIN '._DB_PREFIX_.'smart_blog_post_lang sl ON s.id_smart_blog_post = sl.id_smart_blog_post and sl.id_lang = '.($id_lang).' INNER JOIN '._DB_PREFIX_.'smart_blog_post_shop ps ON ps.id_smart_blog_post = s.id_smart_blog_post AND ps.id_shop = '.(int) Context::getContext()->shop->id. ' where s.active = 1 and MONTH(s.created) = '.(int)$month.' AND YEAR(s.created) = '.(int)$year.' ORDER BY s.id_smart_blog_post DESC';
        } elseif ($month == '' and $month == null and $year != '' and $year != null) {
            $sql = 'SELECT * FROM '._DB_PREFIX_.'smart_blog_post s INNER JOIN '._DB_PREFIX_.'smart_blog_post_lang sl ON s.id_smart_blog_post = sl.id_smart_blog_post and sl.id_lang = '.($id_lang).' INNER JOIN '._DB_PREFIX_.'smart_blog_post_shop ps ON ps.id_smart_blog_post = s.id_smart_blog_post AND ps.id_shop = '.(int) Context::getContext()->shop->id. ' where s.active = 1 AND YEAR(s.created) = '.(int)$year.' ORDER BY s.id_smart_blog_post DESC';
        } elseif ($month != '' and $month != null and $year == '' and $year == null) {
            $sql = 'SELECT * FROM '._DB_PREFIX_.'smart_blog_post s INNER JOIN '._DB_PREFIX_.'smart_blog_post_lang sl ON s.id_smart_blog_post = sl.id_smart_blog_post and sl.id_lang = '.$id_lang.' INNER JOIN '._DB_PREFIX_.'smart_blog_post_shop ps ON ps.id_smart_blog_post = s.id_smart_blog_post AND ps.id_shop = '.(int) Context::getContext()->shop->id. ' where s.active = 1 AND   MONTH(s.created) = '.(int)$month.'  ORDER BY s.id_smart_blog_post DESC';
        } else {
            $sql = 'SELECT * FROM '._DB_PREFIX_.'smart_blog_post s INNER JOIN '._DB_PREFIX_.'smart_blog_post_lang sl ON s.id_smart_blog_post = sl.id_smart_blog_post and sl.id_lang = '.($id_lang).' INNER JOIN '._DB_PREFIX_.'smart_blog_post_shop ps ON ps.id_smart_blog_post = s.id_smart_blog_post AND ps.id_shop = '.(int) Context::getContext()->shop->id. ' where s.active = 1 ORDER BY s.id_smart_blog_post DESC';
        }
    ...
    {
        $sql = 'SELECT DAY(p.created) as day FROM '._DB_PREFIX_.'smart_blog_post p INNER JOIN '._DB_PREFIX_.'smart_blog_post_shop ps ON p.id_smart_blog_post = ps.id_smart_blog_post AND ps.id_shop = '.(int) Context::getContext()->shop->id.' where MONTH(p.created) = '.(int)($month).' AND YEAR(p.created) = '.(int)($year).' GROUP BY DAY(p.created)';
    ...
    {
        $sql = 'SELECT MONTH(p.created) as month FROM '._DB_PREFIX_.'smart_blog_post p  INNER JOIN '._DB_PREFIX_.'smart_blog_post_shop ps ON p.id_smart_blog_post = ps.id_smart_blog_post AND ps.id_shop = '.(int) Context::getContext()->shop->id.' where YEAR(p.created) = '.(int)($year).' GROUP BY MONTH(p.created)';
    ...
    {
        $result = array();
        $sql = 'SELECT YEAR(p.created) as year FROM '._DB_PREFIX_.'smart_blog_post p INNER JOIN '._DB_PREFIX_.'smart_blog_post_shop ps ON p.id_smart_blog_post = ps.id_smart_blog_post AND ps.id_shop = '.(int) Context::getContext()->shop->id.' GROUP BY YEAR(p.created)';
    ...
    public static function smartBlogSearchPost($keyword = null, $id_lang = null, $limit_start = 0, $limit = 5)
    {
        ...
        $sql = 'SELECT * FROM '._DB_PREFIX_.'smart_blog_post_lang pl, '._DB_PREFIX_.'smart_blog_post p WHERE pl.id_lang='.(int)($id_lang).'  AND p.active = 1 AND pl.id_smart_blog_post=p.id_smart_blog_post AND (pl.meta_title LIKE \'%'.pSQL($keyword).'%\' OR pl.meta_keyword LIKE \'%'.pSQL($keyword).'%\' OR pl.meta_description LIKE \'%'.pSQL($keyword).'%\' OR pl.content LIKE \'%'.pSQL($keyword).'%\') ORDER BY p.id_smart_blog_post DESC';
        if (!$posts = Db::getInstance()->executeS($sql)) {
            return false;
        }
    ...
    public static function smartBlogSearchPostCount($keyword = null, $id_lang = null)
    {
        ...
        $sql = 'SELECT * FROM '._DB_PREFIX_.'smart_blog_post_lang pl, '._DB_PREFIX_.'smart_blog_post p WHERE pl.id_lang='.(int)($id_lang).' AND pl.id_smart_blog_post=p.id_smart_blog_post AND p.active = 1 AND (pl.meta_title LIKE \'%'.pSQL($keyword).'%\' OR pl.meta_keyword LIKE \'%'.pSQL($keyword).'%\' OR pl.meta_description LIKE \'%'.pSQL($keyword).'%\' OR pl.content LIKE \'%'.pSQL($keyword).'%\') ORDER BY p.id_smart_blog_post DESC';
        if (!$posts = Db::getInstance()->executeS($sql)) {
            return false;
        }
        return count($posts);
    ...
    public static function getPostLatestHome($limit)
    {
        ...
        $result = array();
        $sql = 'SELECT * FROM '._DB_PREFIX_.'smart_blog_post p INNER JOIN '._DB_PREFIX_.'smart_blog_post_lang pl ON p.id_smart_blog_post=pl.id_smart_blog_post INNER JOIN '._DB_PREFIX_.'smart_blog_post_shop ps ON pl.id_smart_blog_post = ps.id_smart_blog_post AND ps.id_shop = '.(int) Context::getContext()->shop->id.' WHERE pl.id_lang='.($id_lang).' AND p.active= 1 ORDER BY p.id_smart_blog_post DESC LIMIT '.(int)$limit;
        $posts = Db::getInstance(_PS_USE_SQL_SLAVE_)->executeS($sql);
        if (empty($posts)) {
            $sql2 = 'SELECT * FROM '._DB_PREFIX_.'smart_blog_post p INNER JOIN '._DB_PREFIX_.'smart_blog_post_lang pl ON p.id_smart_blog_post=pl.id_smart_blog_post INNER JOIN '._DB_PREFIX_.'smart_blog_post_shop ps ON pl.id_smart_blog_post = ps.id_smart_blog_post  AND ps.id_shop = '.(int) Context::getContext()->shop->id.' WHERE pl.id_lang='.$id_lang_defaut.' AND p.active= 1 ORDER BY p.id_smart_blog_post DESC LIMIT '.(int)$limit;
        ...
        foreach ($posts as $post) {
            ...
            $result[$i]['is_featured'] = $post['is_featured'];
            $result[$i]['link_rewrite'] = $post['link_rewrite'];
            $title_category = $BlogCategory->getNameCategory($post['id_category']);
            $result[$i]['title_category'] =  $title_category[0]['meta_title'];
            $result[$i]['cat_link_rewrite'] = $title_category[0]['link_rewrite'];
            $employee = new  Employee($post['id_author']);
            $result[$i]['lastname'] = $employee->lastname;
            $result[$i]['firstname'] = $employee->firstname;
