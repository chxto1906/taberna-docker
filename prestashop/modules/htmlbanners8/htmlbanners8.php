...
class HtmlBanners8 extends Module implements WidgetInterface
{
    ...
    protected function installSamples()
    {
        ...
        foreach ($languages as $language) {
            ...
            $slide->url[$language['id_lang']] = 'https://www.prestashop.com/en?utm_source=back-office&utm_medium=v17_htmlbanners8'
    ...
    public function getWidgetVariables($hookName = null, array $configuration = array())
    {
        ...
        return array(
            'htmlbanners8' => array(
                ...
                'pause' => $config['HTMLBANNERS8_PAUSE_ON_HOVER'] ? 'hover' : '',
        ...
        $fields_form = array(
            'form' => array(
                ...
                'input' => array(
                    ...
                    array(
                        'type' => 'text',
                        'label' => $this->l('Display on selected category page'),
                        'name' => 'category',
                        'desc' => $this->l('Specify ID of category, where you want to display this banner. For example: "3". If you want to display this banner on all categories pages, leave this field blank.'),
                        'lang' => true,
                    ),
                    array(
                        'type' => 'textarea',
