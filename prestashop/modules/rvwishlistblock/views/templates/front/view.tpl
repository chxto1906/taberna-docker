...
{block name='content'}
    <div id="view_wishlist">
        <h1 class="h1">
            {l s='Wishlist' mod='rvwishlistblock'}
        </h1>
        {if $wishlists}
            <p>
                <strong class="dark">
                    {l s='Other wishlists of %1s %2s:' sprintf=[$current_wishlist.firstname, $current_wishlist.lastname] mod='rvwishlistblock'}
                </strong>
                {foreach from=$wishlists item=wishlist name=i}
                    {if $wishlist.id_wishlist != $current_wishlist.id_wishlist}
                        <a href="{$link->getModuleLink('rvwishlistblock', 'view', ['token' => $wishlist.token])|escape:'html':'UTF-8'}" rel="nofollow" title="{$wishlist.name|escape:'html':'UTF-8'}">
                        ...
                        <div class="product-container">
                            ...
                            <div class="product-description">
                                ...
                                <p class="form-group">
                                    ...
                                    <span class="priority">
                                        {if $wishlist.priority == 0}{l s='High' mod='rvwishlistblock'}{/if}
                                        {if $wishlist.priority == 1}{l s='Medium' mod='rvwishlistblock'}{/if}
                                        {if $wishlist.priority == 2}{l s='Low' mod='rvwishlistblock'}{/if}
                                    </span>
                                </p>

                                <div class="btn_action">
                                    <div class="product-add-to-cart">
                                        <a class="btn btn-primary more" href="{$product.url}" title="{l s='View' mod='rvwishlistblock'}" rel="nofollow">
                                            <span>{l s='View' mod='rvwishlistblock'}</span>
                                        </a>
                                    </div>
                                </div>
                            </div>
