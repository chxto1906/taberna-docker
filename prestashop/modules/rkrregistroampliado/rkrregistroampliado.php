...
* Permissions are reserved by luisjordan.net
*
* @author     Luis Jordán - Tecnología web
* @copyright  2019 luisjordan.net All right reserved
* @license    Luis Jordán
* @contact    luisjordan1979@gmail.com
*
*/
...
class rkrregistroampliado extends Module
{
    ...
    public function install()
    {
        ...
        // Notificación
        $all_contacts = array('luisjordan1979@gmail.com');
