...
<div id="rkr-wrap" class="panel">
  <div class="panel-heading">
    Luisjordan.net - Módulo de registro ampliado
  </div>
  <div class="form-wrapper">
    Este módulo nos permite integrar los campos de dirección en el formulario de registro. <br /> Para posibles dudas o sugerencias contáctenos en: <a href="mailto:luisjordan1979@gmail.com">luisjordan1979@gmail.com</a><br /><br /> Recuerde que este módulo funciona bajo
    ...
    <form class="defaultForm form-horizontal"
      ...
      <div class="form-group row">
          <div class="control-label col-md-12" style="text-align: center;">
              <b>¿Deseas contratar mis servicios?</b><br/>
              Contactame escribiendo a: luisjordan1979@gmail.com
          </div>
      </div>
