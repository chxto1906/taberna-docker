...
<script>
    ...
    var error_check_message_in_tab_form = "{l s='Error: Image is mandatory.' mod='kbmobileapp' }";
    var text_login_msg = "{l s='"Text of icon" would be visible only when logged in otherwise "Log In" will be shown.' mod='kbmobileapp' }";
    var can_not_delete = "{l s='This record can not be deleted.' mod='kbmobileapp' }";
    var tab_bar_error_msg = "{l s='Minimum two icon records are required to enable tab bar.' mod='kbmobileapp' }";
    var manage_tab_text = "{l s='Manage Tab Bar Layout' mod='kbmobileapp' }";
    var edit_tab_text = "{l s='Edit Tab Bar Layout' mod='kbmobileapp' }";
    var delete_tab_msg = "{l s='Tab icon deleteted succesfully. ' mod='kbmobileapp' }";
    var confirmation_tab_txt = "{l s='Are you sure you want to delete this tab icon' mod='kbmobileapp' }";
    var tab_bar_limit_msg = "{l s='Maximum 5 records can be added. Delete old records to add new ones.' mod='kbmobileapp' }";
...
{if $version eq 1.6}
        <div class="row" id="kbmobileapp_configuration_form">
            ...
            <div class="vss-add-new" style="display:none">
                ...
                {*start: changes made by Aayushi Agarwal on 15 April 2019  to add tab bar functionality*}
                {$add_new_tab_icon_button}{*Variable contains html content, escape not required*}
                {$tabbarform}{*Variable contains html content, escape not required*}
                {$tabbarenableform}{*Variable contains html content, escape not required*}
                {*end: changes made by Aayushi Agarwal on 15 April 2019  to add tab bar functionality*}
        </div>
        {else}
            <div class="row" id="kbmobileapp_configuration_form">
