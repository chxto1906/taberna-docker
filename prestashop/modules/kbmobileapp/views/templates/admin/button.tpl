...
{else if isset($vss_cjc_link)  && $vss_cjc_link eq 'vss_edit_tab_bar_form_old'}
    <button class='edit btn btn-default' title='Edit' onclick='edittabbarform(this);'>
        <i class='icon-pencil'></i>{l s='Edit' mod='kbmobileapp'}
    </button>
{else if isset($vss_cjc_link)  && $vss_cjc_link eq 'vss_edit_tab_bar_form_new'}
    <a class='edit btn btn-default' title='Edit' onclick='edittabbarform(this);'>
        <i class='icon-pencil'></i>{l s='Edit' mod='kbmobileapp'}
    </a>
{else if isset($vss_cjc_link)  && $vss_cjc_link eq 'vss_delete_tab_bar_form_old'}
    <button type='button' class='edit btn btn-default' title='delete' onclick='deletetabbarform(this);' style='cursor:pointer;'>
        <i class='icon-trash' style='padding-right:5px'></i>{l s='Delete' mod='kbmobileapp'}
    </button>
{else if isset($vss_cjc_link)  && $vss_cjc_link eq 'vss_delete_tab_bar_form_new'} 
    <a class='delete' title='Delete' onclick='deletetabbarform(this);' style='cursor:pointer;'>
        <i class='icon-trash' style='padding-right:5px'></i>{l s='Delete' mod='kbmobileapp'}
    </a>
