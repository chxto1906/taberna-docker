...
class HomeBestsellersTab extends Module
{
    ...
    {
        $this->_clearCache('*');
        Configuration::updateValue('HOME_BEST_NBR', 8);
    ...
    public function getContent()
    {
        ...
        if (Tools::isSubmit('submithomebestsellerstab')) {
            $nbr = Tools::getValue('HOME_BEST_NBR');
            ...
            if (isset($errors) && count($errors)) {
                ...
                Configuration::updateValue('HOME_BEST_NBR', (int)$nbr);
    ...
    {
        $nProducts = Configuration::get('HOME_BEST_NBR');
    ...
    {
        return array(
            'HOME_BEST_NBR' => Tools::getValue('HOME_BEST_NBR', (int)Configuration::get('HOME_BEST_NBR')),
        );
    }
}
