...

{
...

	{
        ...
        $tab_texts = array(
            ...
            array(
                ...
                'text' => '<div class="rvcms_outer row">
                                ...
                                <div class="rvbannner-main rvcms1">

                                    <div class="rvbannerinner col-sm-12">
                                        ...
                                        <div class="rvcmsbanner1">
                                            ...
                                            <div class="bannercms-container">
                                                ...
                                                <a href="#">
                                                    ...
                                                    <img src="../themes/PRSD81/assets/img/cms-img.png" alt="" />
        ...
        foreach ($tab_texts as $tab) {
            ...
            $rvcustomblockinfo = new rvcustomblockClass();

            foreach (Language::getLanguages(false) as $lang) {

                $rvcustomblockinfo->text[$lang['id_lang']] = $tab['text'];
