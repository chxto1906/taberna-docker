...
class RvBannerCmsSampleData
{
    ...
    <div class="rvbannerinner">
        <div class="rvcmsbanner1">
            <div class="bannercms-container col-sm-12 col-xs-12">
                <a href="#">
                    <img src="../themes/PRSD81/assets/img/bannercms-1.png" alt="">
                </a>
            </div>
        </div>
    </div>
        ...
        foreach ($tab_texts as $tab) {
            $rvbannercmsblockinfo = new rvbannercmsblockClass();
            foreach (Language::getLanguages(false) as $lang) {
                $rvbannercmsblockinfo->text[$lang['id_lang']] = $tab['text'];
            }
            foreach ($shops_ids as $id_shop) {
                $rvbannercmsblockinfo->id_shop = $id_shop;
                $return &= $rvbannercmsblockinfo->add();
            }
        }
