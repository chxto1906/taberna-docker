...
class RvBottomCmsSampleData
{
	public function initData($base_url)
	{
        ...
        $tab_texts = array(
            array(
                'text' => ' <div class="rvcms_outer">
                                <div class="row">
                                    <div class="rvbannner-main rvcms1 rv-animate-element left-to-right">
                                        <div class="rvbannerinner col-sm-12">
                                            <div class="rvcmsbanner1">
                                                <div class="bannercms-container">
                                                    <a href="#">
                                                        <img src="../themes/PRSD81/assets/img/bottomcms-1.png" alt="" />
                                                    </a>
                                                </div> 
                                            </div>  
                                        </div>
        ...
        foreach ($tab_texts as $tab) {
            $rvcmsblockinfo = new rvbottomcmsblockClass();
