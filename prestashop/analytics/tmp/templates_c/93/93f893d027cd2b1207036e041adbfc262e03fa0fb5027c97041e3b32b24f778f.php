...
class __TwigTemplate_36cfdf01d90103ba135c240c3e43817d1534382c10306f8c96b3f4e08abb5ce3 extends Twig_Template
{
    ...
    <div class=\"reportDocumentation\">
        ";
            ...
            if ( !twig_test_empty((($this->getAttribute(($context["properties"] ?? null), "documentation", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute(($context["properties"] ?? null), "documentation", array()))) : ("")))) {
                echo "<p ng-bind-html=\"";
                echo \Piwik\piwik_escape_filter($this->env, twig_jsonencode_filter($this->getAttribute(($context["properties"] ?? $this->getContext($context, "properties")), "documentation", array())), "html_attr");
                echo "\"></p>";
            }
            // line 45
            echo "        ";
...
{%- endif %}", "@CoreHome/_dataTable.twig", "/html/analytics/plugins/CoreHome/templates/_dataTable.twig");
    }
}
