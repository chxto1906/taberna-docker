...
class __TwigTemplate_fac3cea03459d7b3bcc29603f11284ef15f0582e804b006b63c30d903b87710f extends Twig_Template
{
...
";
        ...
        // line 15
        if ((twig_in_filter(($context["column"] ?? $this->getContext($context, "column")), $this->getAttribute(($context["properties"] ?? $this->getContext($context, "properties")), "report_ratio_columns", array())) && twig_in_filter(($context["column"] ?? $this->getContext($context, "column")), twig_get_array_keys_filter(($context["totals"] ?? $this->getContext($context, "totals")))))) {
            // line 16
            ...
            // line 18
            echo "    ";
            if ((((isset($context["siteSummary"]) || array_key_exists("siteSummary", $context)) &&  !twig_test_empty(($context["siteSummary"] ?? $this->getContext($context, "siteSummary")))) && $this->getAttribute(($context["siteSummary"] ?? $this->getContext($context, "siteSummary")), "getFirstRow", array()))) {
                // line 19
                echo "        ";
...
";
    ...
    ";
            // line 45
            if (((isset($context["properties"]) || array_key_exists("properties", $context)) &&  !twig_test_empty($this->getAttribute(($context["properties"] ?? $this->getContext($context, "properties")), "tooltip_metadata_name", array())))) {
                echo "title=\"";
...
{% endspaceless %}
", "@CoreHome/_dataTableCell.twig", "/html/analytics/plugins/CoreHome/templates/_dataTableCell.twig");
    }
}
