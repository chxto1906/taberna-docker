...
/* contentBlock.twig */
class __TwigTemplate_193451ba889f6da7841c7f94161f5fa63be48b0bc56b183f60316b2bfb822ea2 extends Twig_Template
{
    ...
    <div class=\"card-content\">
        ...
        if (((isset($context["title"]) || array_key_exists("title", $context)) && ($context["title"] ?? $this->getContext($context, "title")))) {
            ...
            echo "            <h2 class=\"card-title\"
                  ";
            // line 5
            if ((((isset($context["rate"]) || array_key_exists("rate", $context)) && ($context["rate"] ?? $this->getContext($context, "rate"))) && call_user_func_array($this->env->getTest('true')->getCallable(), array(($context["rate"] ?? $this->getContext($context, "rate")))))) {
...
</div>", "contentBlock.twig", "/html/analytics/plugins/Morpheus/templates/contentBlock.twig");
    }
}
