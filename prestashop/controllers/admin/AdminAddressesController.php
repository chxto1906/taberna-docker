...
class AdminAddressesControllerCore extends AdminController
{
    ...
    public function __construct()
    {
        ...
        $this->fields_list = array(
            ...
            'latitude' => array(
                'title' => $this->trans('Latitude', array(), 'Admin.Global'),
                'align' => 'right',
            ),
            'longitude' => array(
                'title' => $this->trans('Longitude', array(), 'Admin.Global'),
                'align' => 'right',
            ),
            'city' => array(
    ...
    public function renderForm()
    {
        ...
        foreach ($addresses_fields as $addr_field_item) {
            ...
            } elseif ($addr_field_item == 'latitude') {
                $temp_fields[] = array(
                    'type' => 'text',
                    'label' => $this->trans('Latitude', array(), 'Admin.Global'),
                    'name' => 'latitude',
                    'col' => '2',
                    'required' => true,
                );
            } elseif ($addr_field_item == 'longitude') {
                $temp_fields[] = array(
                    'type' => 'text',
                    'label' => $this->trans('Longitude', array(), 'Admin.Global'),
                    'name' => 'longitude',
                    'col' => '2',
                    'required' => true,
                );
