...
class CustomerAddressFormatterCore implements FormFormatterInterface
{
    ...
    private function getFieldLabel($field)
    {
        ...
        switch ($field) {
            ...
            case 'email':
                return $this->translator->trans('Email', [], 'Shop.Forms.Labels');
            case 'latitude':
                return $this->translator->trans('Latitud', [], 'Shop.Forms.Labels');
            case 'longitude':
                return $this->translator->trans('Longitud', [], 'Shop.Forms.Labels');
            case 'other':
