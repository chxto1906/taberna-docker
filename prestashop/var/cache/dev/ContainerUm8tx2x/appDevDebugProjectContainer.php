...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('FlmwCyr0Qc', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('g1e-egJ3u6', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : $this->services['doctrine.dbal.connection_factory'] = new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory(array())) && false ?: '_'}->createConnection(array('driver' => 'pdo_mysql', 'host' => 'mysql', 'port' => '', 'dbname' => 'la_taberna', 'user' => 'la_taberna', 'password' => 'l@tabern@', 'charset' => 'UTF8', 'driverOptions' => array(1002 => 'SET sql_mode=(SELECT REPLACE(@@sql_mode,\'ONLY_FULL_GROUP_BY\',\'\'))'), 'serverVersion' => 5.1, 'defaultTableOptions' => array()), $a, $c, array('enum' => 'string'));
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $b->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(${($_ = isset($this->services['annotation_reader']) ? $this->services['annotation_reader'] : $this->getAnnotationReaderService()) && false ?: '_'}, array(0 => '/html/src/PrestaShopBundle/Entity')), 'PrestaShopBundle\\Entity');
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_a391955db4d5df6b2304fd011d6a29fd7fa460569bc34a2385476e721f38cbbf');
    ...
    {
        $this->services['twig'] = $instance = new \Twig\Environment(${($_ = isset($this->services['twig.loader']) ? $this->services['twig.loader'] : $this->getTwig_LoaderService()) && false ?: '_'}, array('autoescape' => 'name', 'debug' => true, 'strict_variables' => true, 'form_themes' => $this->parameters['twig.form.resources'], 'paths' => array('/html/app/../src/PrestaShopBundle/Resources/views/Admin/Product' => 'Product', '/html/app/../src/PrestaShopBundle/Resources/views/Admin/TwigTemplateForm' => 'Twig', '/html/app/../src/PrestaShopBundle/Resources/views/Admin/Configure/AdvancedParameters' => 'AdvancedParameters', '/html/app/../src/PrestaShopBundle/Resources/views/Admin/Configure/ShopParameters' => 'ShopParameters', '/html/app/../modules' => 'Modules'), 'exception_controller' => 'twig.controller.exception:showAction', 'cache' => ($this->targetDirs[0].'/twig'), 'charset' => 'UTF-8', 'default_path' => '/html/templates', 'date' => array('format' => 'F j, Y H:i', 'interval_format' => '%d days', 'timezone' => NULL), 'number_format' => array('decimals' => 0, 'decimal_point' => '.', 'thousands_separator' => ',')));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension($b, '/html/app', 'UTF-8'));
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('-upyXhpQ2a', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('DraaRfiwIg', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('+3OsKJj88+', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['debug.file_link_formatter'] = new \Symfony\Component\HttpKernel\Debug\FileLinkFormatter(NULL, ${($_ = isset($this->services['request_stack']) ? $this->services['request_stack'] : $this->services['request_stack'] = new \Symfony\Component\HttpFoundation\RequestStack()) && false ?: '_'}, '/html', function () {
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator(${($_ = isset($this->services['kernel']) ? $this->services['kernel'] : $this->get('kernel', 1)) && false ?: '_'}, '/html/app/Resources', array(0 => '/html/app'));
    }
    ...
    {
        return $this->services['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(${($_ = isset($this->services['uri_signer']) ? $this->services['uri_signer'] : $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('9d56cK8jwQZpCryipSEKS6MOhyiERDosvj1jKnNjGagUwmahaskG1uk0')) && false ?: '_'}, '/_fragment');
    }
    ...
    {
        return $this->services['prestashop.bundle.routing.converter.routing_cache_key_generator'] = new \PrestaShopBundle\Routing\Converter\RoutingCacheKeyGenerator(array(0 => '/html/src/PrestaShopBundle/Resources/config/routing/admin'), ${($_ = isset($this->services['prestashop.module_kernel.repository']) ? $this->services['prestashop.module_kernel.repository'] : $this->load('getPrestashop_ModuleKernel_RepositoryService.php')) && false ?: '_'}->getActiveModulesPaths(), 'dev');
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator(${($_ = isset($this->services['file_locator']) ? $this->services['file_locator'] : $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator(${($_ = isset($this->services['kernel']) ? $this->services['kernel'] : $this->get('kernel', 1)) && false ?: '_'}, '/html/app/Resources', array(0 => '/html/app'))) && false ?: '_'}, $this->targetDirs[0]);
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $a->addPath('/html/app/../modules', 'Modules');
        ...
        $a->addPath('/html/vendor/csa/guzzle-bundle/src/Resources/views', '!CsaGuzzle');
        $a->addPath('/html/vendor/symfony/symfony/src/Symfony/Bundle/DebugBundle/Resources/views', 'Debug');
        $a->addPath('/html/vendor/symfony/symfony/src/Symfony/Bundle/DebugBundle/Resources/views', '!Debug');
        $a->addPath('/html/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views', 'WebProfiler');
        $a->addPath('/html/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views', '!WebProfiler');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('9d56cK8jwQZpCryipSEKS6MOhyiERDosvj1jKnNjGagUwmahaskG1uk0');
    }
        ...
        return array(
            ...
            'kernel.bundles_metadata' => array(
                ...
                'TacticianBundle' => array(
                    'parent' => NULL,
                    'path' => '/html/vendor/league/tactician-bundle',
                    'namespace' => 'League\\Tactician\\Bundle',
                ),
                'DebugBundle' => array(
                    'parent' => NULL,
                    'path' => '/html/vendor/symfony/symfony/src/Symfony/Bundle/DebugBundle',
                    'namespace' => 'Symfony\\Bundle\\DebugBundle',
                ),
                'WebProfilerBundle' => array(
                    'parent' => NULL,
                    'path' => '/html/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle',
                    'namespace' => 'Symfony\\Bundle\\WebProfilerBundle',
                ),
                'SensioDistributionBundle' => array(
                    'parent' => NULL,
                    'path' => '/html/vendor/sensio/distribution-bundle',
                    'namespace' => 'Sensio\\Bundle\\DistributionBundle',
                ),
                'WebServerBundle' => array(
                    'parent' => NULL,
                    'path' => '/html/vendor/symfony/symfony/src/Symfony/Bundle/WebServerBundle',
            ...
            'kernel.active_modules' => array(
                ...
                71 => 'homenewtab',
                72 => 'homeonsaletab',
                73 => 'homebestsellerstab',
                74 => 'blockmanufactureri',
                75 => 'pshomeslider',
                76 => 'htmlbanners9',
                77 => 'rvheaderinfo',
                78 => 'rvheadercontact',
                ...
                83 => 'rvproductstab',
                84 => 'rvbannercmsblock',
                85 => 'rvspecialproducts',
                86 => 'rvcustomblock',
                87 => 'rvcategory',
                88 => 'rvdealoftheday',
                89 => 'rvmanufacturerblock',
                90 => 'smartbloghomelatestnews',
                91 => 'rvfooterstoreinfo',
                92 => 'rvpaymentlogo',
                93 => 'rvleftbanners',
                94 => 'rvtestimonials',
                95 => 'rvcmsblock',
                ...
                102 => 'rvcompare',
                103 => 'rvcookie',
                104 => 'rvproductcountdown',
                105 => 'pleasewait',
                106 => 'codfee',
                107 => 'redirectToShopByLocation',
                108 => 'payphone',
                109 => 'mipilotoshipping',
                110 => 'sincronizacionwebservices',
                111 => 'webservices_taberna',
                112 => 'cotizador_taberna',
                113 => 'cotizadortaberna',
                114 => 'envioemails',
                115 => 'ps_emailalerts',
            ),
            ...
            'database_host' => 'mysql',
            'database_port' => '',
            'database_name' => 'la_taberna',
            'database_user' => 'la_taberna',
            'database_password' => 'l@tabern@',
            'database_prefix' => 'ps_',
            ...
            'secret' => '9d56cK8jwQZpCryipSEKS6MOhyiERDosvj1jKnNjGagUwmahaskG1uk0',
            'ps_caching' => 'CacheMemcache',
            'ps_cache_enable' => false,
            'ps_creation_date' => '2019-02-12',
            'locale' => 'es-ES',
            'cookie_key' => 'jZuPf2RxGWwuIDgJ9syPR3tfGO7EkiqfphPi9m4CsqPb6JCh4hGS0gCx',
            'cookie_iv' => 'btRANqyD',
            'new_cookie_key' => 'def000006c635cd9702bac7541df5737bac175e9a61b777d49be7bd8356caa302763379b6c1605affc92fcdd11eb6ac539faf1b5833c2f05d35fcbcd4721cb4bf44dee1e',
            'cache.driver' => 'array',
            ...
            'kernel.secret' => '9d56cK8jwQZpCryipSEKS6MOhyiERDosvj1jKnNjGagUwmahaskG1uk0',
            ...
            'router.resource' => '/html/app/config/routing_dev.yml',
